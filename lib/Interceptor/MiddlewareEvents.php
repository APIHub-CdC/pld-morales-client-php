...
namespace PldPmClientePhp\Client\Interceptor;
...
use \PldPmClientePhp\Client\Interceptor\KeyHandler;
use \PldPmClientePhp\Client\Interceptor\MyLogger;
use \PldPmClientePhp\Client\Model\Errors;
use \PldPmClientePhp\Client\Model\Error;

class MiddlewareEvents
{
    
    function __construct(\PldPmClientePhp\Client\Interceptor\KeyHandler $signer)
    {
        $this->signer = $signer;
...
function build_error($code, $message){
    $error = new \PldPmClientePhp\Client\Model\Error([
        "code" => $code,
        "message" => $message
    ]);
    $errors = new \PldPmClientePhp\Client\Model\Errores(["errors" => [$error]]);
